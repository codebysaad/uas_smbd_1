    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Data Pelanggan</h1>
                    </div>
                ...
                <?php 
                    ...
                    $id = $_GET['id'];
                    $tsql = "SELECT * FROM Pelanggan WHERE idPel='$id'";
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <form method="post" action="crud/action_ubah_data_pelanggan.php">
                    <div class="row">
                      <div class="col-md-5">
