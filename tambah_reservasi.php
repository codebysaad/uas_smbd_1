            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Reservasi Baru</h1>
                    </div>

            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <form method="post" action="crud/action_tambah_reservasi.php">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">ID Reservasi</label>
                          <input name="idReservasi" type="text" class="form-control">
                        </div>
                      </div>
                        <div class="form-group col-md-12">
                            ...
                            <select name="lantai" id="inputState" class="form-control">
                                ...
                                $no = 1;
                                $tsql = "SELECT * FROM Kamar WHERE isAvailable=1 ORDER BY lantai";
                                ...
                                <option value="<?php $d['idKmr'];?>">
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <h4>Tipe: <?php echo $d['jenisKmr'];?></h4>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input id="datepicker" type="date"  name="tglCheckin"  class="form-control datepicker"  required/>
                        </div>
                        <div class="form-group col-md-4">
